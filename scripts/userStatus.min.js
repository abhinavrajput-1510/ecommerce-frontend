...
function renderUserStatus() {
  ...
  if (!t)
    return (
      ...
      void (userStatus.href = "auth.html")
    );
  try {
    const e = JSON.parse(t),
      r = e.displayName || e.email.split("@")[0];
    ((userStatus.textContent = `Hello, ${r}`), (userStatus.href = "auth.html"));
  } catch (t) {
    ((userStatus.textContent = "Hello, Guest"),
...
(renderUserStatus(),
  window.addEventListener("storage", (t) => {
    "currentUser" === t.key && renderUserStatus();
  }),
